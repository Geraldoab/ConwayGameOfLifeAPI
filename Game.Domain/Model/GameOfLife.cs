namespace Game.Domain.Model
{
    public class GameOfLife
    {
        ...
        private bool IsDeadByUnderPopulationRule(int currentCell, int liveNeighborsTotal)
        {
        ...
        private bool IsDeadByOverPopulationRule(int currentCell, int liveNeighborsTotal)
        {
        ...
        private bool IsAliveByReproductionRule(int currentCell, int liveNeighborsTotal)
        {
        ...
        private int CountLiveNeighbors(int[,] currentBoardGeneration, int currentCellColumn, int currentCellRow)
        {
